      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <SectionHeader
          ...
          title={
            <>
              Stuff I've{' '}
              <span className="text-[color:var(--retro-green)]">
                built so far
              </span>
            </>
          }
  ...
  return (
    <article className="group pixel-card p-5 h-full flex flex-col relative overflow-hidden transition-transform hover:-translate-y-1 hover:translate-x-[-2px] hover:shadow-[8px_8px_0_0_var(--ink)]">
      ...
      <div
        ...
        style={{
          background: `color-mix(in oklab, ${project.color} 35%, var(--paper))`,
        }}
      >
      ...
      <p className="mt-2 text-base text-foreground/75 leading-snug flex-1">
        {project.description}
      </p>
      ...
      <div className="mt-4 flex flex-wrap gap-1.5">
        {project.tech.map((t) => (
          <span
            key={t}
            className="pixel-chip px-2 py-0.5 font-mono text-[10px] font-bold"
          >
            {t}
          </span>
        ))}
      ...
      <div className="mt-4 flex gap-2">
        <a
          href={project.demo}
           target="_blank"
          className="pixel-btn  inline-flex items-center gap-1 px-3 py-1.5 font-mono text-[10px] font-bold uppercase"
        >
        ...
        <a
          ...
          className="inline-flex items-center gap-1 border-2 border-[color:var(--ink)] bg-[color:var(--paper)] px-3 py-1.5 font-mono text-[10px] font-bold uppercase shadow-[2px_2px_0_0_var(--ink)] hover:bg-[color:var(--retro-yellow)]"
        >
          <Github size={11} /> Code
        </a>
      </div>
